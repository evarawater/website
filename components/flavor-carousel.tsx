                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      {!currentFlavor.mystery && currentFlavor.badges && currentFlavor.badges.length > 0 && (
                        <motion.div
